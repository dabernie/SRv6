...
frontPanelPorts = [
    "5/1", "19/0",  "20/0", "29/0", "29/1", "29/2", "29/3", "30/0", "30/1", "30/2", 
    "30/3", "31/0", "32/0"
]
...
class IPv6FabricTest(api_base_tests.ThriftInterfaceDataPlane):
    ...
    def setUp(self):
        ...
        self.NEIGHBORS = [{
            'IP': '2650:a800:fffe::0',
            'MAC': '00:08:a2:0b:81:dd'
        }, {
            'IP': '2650:a800:fffe::4',
            'MAC': 'a8:2b:b5:35:eb:01'
        }, {
            'IP': '2650:a800:fffe::2',
            'MAC': '8c:ea:1b:e4:93:b1'
        }]
------
        # routes to program
        self.L1_ROUTES= [{
